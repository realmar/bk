...
var apply_changes_tpl         = '<p class="' + MSG_USER + ' ' + CHAG_CONT + ' ' + AH_MESSAGE + '">You changed the content. To Apply the changes <span class="mark_yellow">(colored yellow)</span> press Save</p>';
