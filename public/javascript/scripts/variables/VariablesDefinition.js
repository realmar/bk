...
var dom_double_data_entry_tpl = '<p class="' + MSG_ERRORS + ' ' + DBL_DATA + '">ERROR: dbl_data<br>You assigned a Username to at least two Doors<br>A User can only be assigned to one Door</p>';
